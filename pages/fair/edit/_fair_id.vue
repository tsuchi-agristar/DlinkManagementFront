...
export default {
	...
	computed: {
		...
		inputDiff () {
			let event_member =  Object.assign({}, this.fair_dt.event_member);
			let pristine_event_member =  Object.assign({}, this.pristine_fair_dt.event_member);

			let fair_dt = Object.assign({}, this.fair_dt);
			delete fair_dt.event_member;
			let pristine_fair_dt = Object.assign({}, this.pristine_fair_dt);
			delete pristine_fair_dt.event_member;
			// 配列は入力順でデータ順が変わってしまうため、ソートして比較する
			return _.isEqual(pristine_fair_dt, fair_dt) && _.isEqual(_.sortBy(pristine_event_member), _.sortBy(event_member))
		},
	},
